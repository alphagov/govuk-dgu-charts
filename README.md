...
- Before the new job runs you may need to remove existing script job `kubectl delete job/ckan-ckan-script -n datagovuk`, otherwise the new job will fail with a sync error or will not run.
